...
db_name= 'aan_1'
db_path = 'C:/Users/grizz/OneDrive/Desktop/COSC448/ideas/model/DAIL-SQL/dataset/cosc304/database/shipment_database/shipment_database.sqlite'
...
print(mschema_str)
mschema.save(f'./M-schema/{db_name}.json')
